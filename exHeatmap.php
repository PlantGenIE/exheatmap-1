...
var samples = ["experiment_2", "experiment_1", "experiment_3", "experiment_4"];
 ...
 <head>
 	...
 	<script src="plugins/exheatmap/js/kinetic-v5.1.0.min.js"></script> 
 	<script src="plugins/exheatmap/js/inchlib-1.2.0.min.js"></script>
	 <script src="plugins/exheatmap/js/jspdf.min.js"></script>
 </head>
...
<div onClick="return toggleMe()" id="newtable_4title">+ Selected Genes <strong><?php echo ' '.count($efppieces);?></strong></div>
 ...
 <script src="plugins/exheatmap/js/init.js"></script> 
